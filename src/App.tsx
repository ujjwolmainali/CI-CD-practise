...
const App: React.FC = () => {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <header className="max-w-5xl mx-auto px-6 py-20 md:py-32 flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 space-y-6">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-slate-900">
            Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-blue-500">Ujjwol</span>.
          </h1>
          <p className="text-xl text-slate-600 max-w-lg leading-relaxed">
            I'm a passionate <strong className="text-slate-800 font-semibold">Frontend Developer</strong> specializing in building exceptional digital experiences using React.
          </p>
          <div className="flex gap-4 pt-4">
            <a href="mailto:your.email@example.com" className="bg-indigo-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200 flex items-center gap-2">
              <Mail size={20} /> Let's Talk
            </a>
            <a href="https://github.com" target="_blank" rel="noreferrer" className="bg-white text-slate-700 border border-slate-200 px-6 py-3 rounded-lg font-medium hover:border-slate-300 hover:bg-slate-50 transition-all flex items-center gap-2">
        ...
        <div className="flex-1 relative">
          <div className="aspect-square max-w-sm mx-auto bg-gradient-to-tr from-indigo-100 to-blue-50 rounded-3xl overflow-hidden border border-slate-100 shadow-2xl flex items-center justify-center">
            {/* You can replace this Terminal icon with an actual <img src="..." /> of yourself later */}
        ...
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-2xl border border-slate-100 bg-slate-50/50 hover:bg-slate-50 transition-colors">
              <h3 className="text-lg font-bold text-slate-900">Bachelor of Information Technology (BIT)</h3>
              <p className="text-slate-500 mt-2">Focused on modern software development practices, web technologies, and computer science fundamentals.</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              {['React', 'TypeScript', 'Tailwind CSS', 'JavaScript', 'HTML5', 'CSS3', 'Git'].map((skill) => (
      ...
      <footer id="contact" className="max-w-5xl mx-auto px-6 py-12 flex flex-col items-center justify-center text-center space-y-6">
        ...
        <p className="text-sm text-slate-500">© {new Date().getFullYear()} Ujjwol Mainali. Crafted with React & Tailwind.</p>
      </footer>
